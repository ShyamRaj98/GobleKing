        ...
        <section className='contact_section'>
            ...
            <Container maxWidth={'lg'}>
                ...
                <div className='contact_form'>
                    <h1 className='cf_title'>How can we help you?</h1>
                    <p className='cf_para'>To meet your engineering needs, GkBIM provides professional, cost-effective and sustainable service and designs. Contact us to receive more information or to schedule your consultation.</p>
                    <p className='cf_small_para'>Press inquiry? Visit our <Link className='under_line'>Press Center</Link>.</p>
                    <form onSubmit={sendEmail}>
                    <input id="form-type" className='hidden_field' type='text' required name="form-type" value="Contact" />
                        ...
                        <div className='cf_btn_field'>
                            <input type="submit" className='cf_btn' value="Submit" />
                        </div>
                    </form>
                    {/* <form onSubmit={sendEmail}>
